...
class UserBehavior(TaskSet):
    ...
    def doIdentify(self):
        identify_params = {
            ...
            "replay_detect": False,
            "channel": 0,
            "bz_voice_group_id":"ab0cdec3c25811e9a667eec3ba5a957a-c8396945917511e989a3fa163e91236e-c83a7583b81211e98f1bfa163e91236e-1d005b30b8d711e98f1bfa163e91236e-8ac7fc50db7711e9bed8fa163e91236e-6ece5457db7711e9bed8fa163e91236e",
            "yb_voice_group_id":"cf8f7751b1e211e9bf04fa163e91236e-7a14ee6edb7711e9bed8fa163e91236e-b8ff6352db7711e9bed8fa163e91236e",
            "jc_voice_group_id":"2b77f6b4b1de11e98917fa163e91236e-48e66c0ad50411e98ff6fa163e91236e-7ae65b3fb29611e9a9ebfa163e91236e"
        }
        wave_file = {"wave_file": open("./voice/{}".format(long_voice_list[random.randint(0, 19)]), 'rb')}
        try:
            with self.client.post("/kvp_mps/v1/voiceprints/identify",
                                               params=identify_params,
                                               headers=self.file_headers,
                                               files=wave_file,
                                               catch_response=True,
                                               ) as identify_response:
                print("identify result: {}".format(identify_response.text))
                identify_res_dict = json.loads(identify_response.text)
                if identify_res_dict['code'] != 0:
                    identify_response.failure(identify_res_dict)
        except Exception as e:
            identify_response.failure(str(e))
