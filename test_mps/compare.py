...
class UserBehavior(TaskSet):
    ...
    def doCompare(self):
        compare_params = {
            "idcard": 310101196307064724,
            "voice_group_id":"27439e5185dc11e989a3fa163e91236e",
            "voiceprint_enroll_file_info_id":"35",
            "text_type": "ti",
            "replay_detect": False,
            "mix_detect":False,
            "channel":0,
        ...
        compare_response = self.client.post("/kvp_mps/v1/voiceprints/compare",
                                           params=compare_params,
                                           headers=self.file_headers,
                                           files=wave_file,
                                           )
        compare_res_dict = json.loads(compare_response.text)
        print("compare result: {}".format(compare_res_dict))
